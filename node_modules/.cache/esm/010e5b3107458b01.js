let User,jwt;_074‍.x([["register",()=>register],["login",()=>login]]);_074‍.w("../models/user",[["default",["User"],function(v){User=v}]]);_074‍.w("jsonwebtoken",[["default",["jwt"],function(v){jwt=v}]]);
    ...
    try {
        await user.save()
        _074‍.g.console.log("User created", user.name)
        return res.json({user})
        
    } catch (error) {
        _074‍.g.console.log("Create User Failed", user)
    ...
    try {
        ...
        user.comparePassword(password, (err,match)=>{
            ...
            _074‍.g.console.log("COMPARE PASSWORD IN LOGIN ERROR", err)
        ...
        _074‍.g.console.log('LOGIN ERROR', err)
